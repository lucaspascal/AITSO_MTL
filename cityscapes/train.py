...
from losses import CityscapesLoss
from metrics import CityscapesMetrics
...
parser.add_argument('--dataroot', default='/data/cityscapes/')
parser.add_argument('--checkpoint_path', default='/saved_models/cityscapes/')
...
parser.add_argument('--eval_interval', default=1000, type=int, help='interval between two validations')
parser.add_argument('--total_epoch', default=150, type=int, help='number of training epochs to proceed')
...
# Defines input tasks
task_groups, n_tasks = utils.create_task_groups(opt)
...
# Loss and metrics
loss_func = CityscapesLoss(task_groups, opt)
train_metrics = CityscapesMetrics(task_groups, opt)
val_metrics = CityscapesMetrics(task_groups, opt)
...
use_bg = False
train_data = Cityscapes(dataset_path, 
                   split='train')
val_data = Cityscapes(dataset_path, 
                 split='val')
